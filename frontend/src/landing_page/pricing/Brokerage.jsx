function Brokerage() {
  return (
    <div className="container text-muted" style={{color:"#424242"}}>
      <div className="row">
      <h3 className="text-center">Charges Explained</h3>
        <div className="col-1 "></div>
        <div className="col me-5 p-5">
          ...
          <p>
            When trading at StockHive, STT/CTT can be a lot more than the
